...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:za,depthTest:!1,depthWrite:!1})}function B_(){return new Ha({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:vd(),fragmentShader:`
		...
		`,blending:za,depthTest:!1,depthWrite:!1})}function I_(){return new Ha({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vd(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Eb(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===nv?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===iv?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Ji&&(t="SHADOWMAP_TYPE_VSM"),t}function Tb(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case ys:case xs:t="ENVMAP_TYPE_CUBE";break;case Ac:t="ENVMAP_TYPE_CUBE_UV";break}return t}function bb(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case xs:t="ENVMAP_MODE_REFRACTION";break}return t}function Ab(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case ad:t="ENVMAP_BLENDING_MULTIPLY";break;case uy:t="ENVMAP_BLENDING_MIX";break;case fy:t="ENVMAP_BLENDING_ADD";break}return t}function Rb(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function Cb(o,t,i,r){const l=o.getContext(),u=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=Eb(i),p=Tb(i),g=bb(i),_=Ab(i),S=Rb(i),M=mb(i),b=gb(u),C=l.createProgram();let x,v,I=i.glslVersion?"#version "+i.glslVersion+`
...
`].filter(Co).join(`
`)),h=ed(h),h=Z_(h,i),h=j_(h,i),d=ed(d),d=Z_(d,i),d=j_(d,i),h=K_(h),d=K_(d),i.isRawShaderMaterial!==!0&&(I=`#version 300 es
...
`)+`
`+v);const P=I+x+h,U=I+v+d,V=W_(l,l.VERTEX_SHADER,P),k=W_(l,l.FRAGMENT_SHADER,U);l.attachShader(C,V),l.attachShader(C,k),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function z(F){if(o.debug.checkShaderErrors){const ot=l.getProgramInfoLog(C).trim(),st=l.getShaderInfoLog(V).trim(),_t=l.getShaderInfoLog(k).trim();let ft=!0,O=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(ft=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,V,k);else{const K=Y_(l,V,"vertex"),X=Y_(l,k,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
